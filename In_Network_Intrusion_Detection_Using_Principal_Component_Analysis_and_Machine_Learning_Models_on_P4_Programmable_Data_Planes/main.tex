...
P4DDLe~\cite{Doriguzzi-Corin2024} & Hy & Not applied   & \ding{51} & B & \ding{55} \\
...
\multicolumn{6}{l}{\textsuperscript{c}Range match for the DT members; the LR members use register-held conditional arithmetic, not table match.} \\
\end{tabular}
\end{table}
