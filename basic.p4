    ...
    apply {
        if ((hdr.ipv4.isValid() && (meta.protocol == TYPE_TCP || meta.protocol == TYPE_UDP ||
            ...
            if (meta.flow_ended == 1w1 &&
                ...
                meta.min_iat_q = (bit<16>)(meta.min_iat >> 20);
                ...
                meta.flags_urg_q = (bit<8>)meta.flags_urg;
